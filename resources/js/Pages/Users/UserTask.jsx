...
const action = [
    {"route": "user.tasks.edit", "label": "Edit"},
]

export default function UserTask({ auth, tasks, user_id }) {
    ...
    return (
        ...
        >
            <div className='flex flex-col mx-2 mt-2 sm:px-6 lg:px-8'>
                <>
                    <Link className='w-30 py-2' href="/users">{"< Back"}</Link>
                    <div className='w-30 py-2 flex justify-between' >
                        <div className='flex justify-between items-center'>
                            ...
                            <Link
                                href={route('user.tasks',user_id)+'?search='+filterText}
                                only={['tasks']}
                            >
                                <PrimaryButton>
                                    Search
